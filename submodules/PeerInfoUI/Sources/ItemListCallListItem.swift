...
public class ItemListCallListItem: ListViewItem, ItemListItem {
    ...
    public init(presentationData: ItemListPresentationData, dateTimeFormat: PresentationDateTimeFormat, messages: [Message], sectionId: ItemListSectionId, style: ItemListStyle, displayDecorations: Bool = true, currentDate: Date) {
...
public class ItemListCallListItemNode: ListViewItemNode {
    ...
    public func asyncLayout() -> (_ item: ItemListCallListItem, _ params: ListViewItemLayoutParams, _ insets: ItemListNeighbors) -> (ListViewItemNodeLayout, () -> Void) {
        ...
        return { [weak self] item, params, neighbors in
            ...
            let titleText = stringForDate(timestamp: Int32(item.currentDate.timeIntervalSince1970), strings: item.presentationData.strings)
